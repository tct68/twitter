...
const MenuItem = (props: MenuItemProps) => {
  return (
    <a
      ...
      className='css-4rbku5 css-18t94o4 flex-column r-1habvwh r-1loqt21 r-6koalj r-eqz5dr flex-grow  r-oyd9sg r-13qz1uu'
    >
      <div className='flex-column items-center rounded-element row r-1777fci r-dnmrzs r-xyw6el r-o7ynqc r-6416eg menu-item'>
