...
const TabItem = (props: TabItemProps) => {
  return (
    ...
    >
      <a className='css-4rbku5 css-18t94o4 flex-column items-center r-1loqt21 r-6koalj r-eqz5dr flex-grow r-1h3ijdo r-1777fci r-s8bhmr  r-1qhn6m8 r-i023vh r-o7ynqc r-6416eg'>
